...
<body>
  ...
  <section class="menu menu3 cid-sgD4skfxXw" once="menu" id="menu3-0">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container-fluid">
			...
			<a href="cos.html">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-danger text-primary display-5" href="index.html">Glammy</a></span>
            </div>
...
<section class="header18 cid-sgD4AgfncR mbr-fullscreen" id="header18-1">
    ...
    <div class="align-center container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3 display-1"><strong>Be glamorous. Be you.</strong></h1>
                <h2 class="mbr-section-subtitle mbr-fonts-style mbr-white mb-3 display-2"><strong>Glammy</strong></h2>
                
                <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="">Design your own glammy style</a></div>
            </div>
        </div>
    </div>
